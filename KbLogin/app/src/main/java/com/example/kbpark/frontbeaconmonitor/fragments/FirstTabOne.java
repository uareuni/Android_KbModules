...
public class FirstTabOne extends Fragment implements LoginMain.onKeyBackPressedListener
{
    public static FirstTabOne newInstance() { return new FirstTabOne(); }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        View rootView = inflater.inflate(R.layout.first_one, container, false);
